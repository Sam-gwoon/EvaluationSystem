  ...
  <div id="myExam">
    ...
    <div class="wrapper">
      <ul class="top">
        ...
        <li class="search-li"><div class="icon"><input type="text" placeholder="评测计划名称" class="search" v-model="key"><i class="el-icon-search"></i></div></li>
        <li><el-button type="primary" @click="search()">搜索计划</el-button></li>
      </ul>
